...
export class BuildInteractionController {
    ...
    init() {
        ...
        this.callbackMode = {
            "place": {
                "pointerdown": this.startTilePlace,
                "pointermove": this.moveTilePlace,
                "pointerup": this.stopTilePlace
            },
            "select": {
                "pointerdown": this.startTileSelect,
                "pointermove": this.moveTileSelect,
                "pointerup": this.stopTileSelect
            },
            "fill": {
                "pointerdown": this.startTileFill,
                "pointermove": this.moveTileFill,
                "pointerup": this.stopTileFill
            },
            "bucket": {
                "pointerdown": this.startBucketPlace,
                "pointermove": this.moveBucketPlace,
                "pointerup": this.stopBucketPlace
            }
        };
    ...
    startBucketPlace(event) {
        ...
        while (running) {
            ...
            for (let j = 0; j < sources.length; j++) {
                ...
                sourceTile.chunk.resetCollision();
            }
    ...
    stopTileSelect(event) {
        ...
        console.log(MapContructData.mapDataToString(outArr));
        this.draw = false;
    }
