import {ConstructGenerator} from "../map/constructGenerator"
import {DebugController} from "../map/debugController"
import {WorldEntityController} from "../map/worldEntityController"
import {ChunkController} from "../map/chunkController"
...
export class Map extends Phaser.GameObjects.GameObject {
    ...
    constructor(params) {
        ...
        this.worldEntityController = new WorldEntityController({
            scene: this.scene,
            map: this
        });
