export class Slider extends Phaser.GameObjects.Sprite{
    constructor(params){
        ...
        this.txt = this.scene.add.text(this.x-(this.width/2-this.offset-6), this.y-10, this.text, {fontFamily: 'AtlantisRegular', fontSize: 22, fill: '#fff', align:'center'});

        if(this.group) this.group.add(this.txt);
    ...
    makeFillerGraphic(ratio){
        ...
        this.scene.children.bringToTop(this.txt);
    }
